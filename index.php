...
<body class="bg-gray-900 text-white font-poppins">
    ...
    <!-- Header -->
    <header class="fixed top-0 left-0 right-0 z-50 bg-white bg-opacity-95 backdrop-blur-lg border-b border-gray-200 shadow-lg transition-all duration-300" x-data="{ 
    ...
    " :class="{ 'bg-opacity-100 shadow-xl': scrolled }">
            ...
            <div class="flex justify-between items-center py-4">
                ...
                <div class="flex items-center space-x-3">
                    ...
                    <div class="hidden md:block">
                        <h1 class="text-2xl font-bold text-gray-900 font-chevrola">AGIMO</h1>
                        <p class="text-sm text-gray-600">Immobilier Premium</p>
                    </div>
                </div>
                ...
                <nav class="hidden lg:flex items-left space-x-8">
                    ...
                    <a href="#projet" class="group relative px-4 py-2 text-gray-700 hover:text-primary transition-all duration-300 font-medium">
                        <span class="relative z-10">Le Projet</span>
                        <div class="absolute inset-0 bg-primary rounded-full transform scale-0 group-hover:scale-100 transition-transform duration-300 opacity-10"></div>
                    </a>
                ...
                <div class="hidden md:flex items-center space-x-4">
                    <a href="https://wa.me/2126XXXXXXXX" class="group bg-primary text-white px-6 py-3 rounded-full font-semibold hover:bg-yellow-600 transform hover:-translate-y-1 transition-all duration-300 shadow-lg hover:shadow-xl">
            ...
            <div x-show="mobileMenuOpen" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 transform -translate-y-4" x-transition:enter-end="opacity-100 transform translate-y-0" x-transition:leave="transition ease-in duration-200" x-transition:leave-start="opacity-100 transform translate-y-0" x-transition:leave-end="opacity-0 transform -translate-y-4" class="lg:hidden absolute top-full left-0 right-0 bg-white border-t border-gray-200 shadow-xl">
                <nav class="px-6 py-6 space-y-4">
                    ...
                    <a href="#projet" @click="mobileMenuOpen = false" class="flex items-center space-x-3 px-4 py-3 rounded-xl hover:bg-gray-50 transition-colors duration-300">
                        <div class="w-2 h-2 bg-primary rounded-full"></div>
                        <span class="text-gray-700 font-medium">Le Projet</span>
                    </a>
                    ...
                    <div class="pt-4 border-t border-gray-200">
                        <a href="https://wa.me/2126XXXXXXXX" class="block bg-primary text-white text-center px-6 py-3 rounded-full font-semibold hover:bg-yellow-600 transition-colors duration-300">
   ...
   <!-- Hero Section -->
    <section class="h-screen md:mt-20 flex flex-col" style="background-image: url('assets/images/hero.webp'); background-size: cover; background-position: center;">
        <!-- First div -->
        <div class="bg-black bg-opacity-55 w-full h-5/6 flex flex-col items-center justify-center text-center pt-32 px-6">
            <div class="max-w-5xl mx-auto space-y-10">

                <!-- Main Title -->
                <div class="space-y-8">
                    <h1 class="text-5xl md:text-6xl lg:text-7xl font-bold text-white leading-tight font-chevrola">
                        Résidence <span class="text-primary">haut standing</span>
                ...
                <div class="pt-4">
                    <p class="text-xl md:text-2xl text-white text-opacity-90 leading-relaxed max-w-3xl mx-auto">
                        Un cadre de vie exceptionnel, au cœur d'une résidence haut standing où 
                        <span class="text-primary font-semibold">luxe</span>, 
                        <span class="text-primary font-semibold">confort</span> et 
                        <span class="text-primary font-semibold">tranquillité</span> se rencontrent.
                    </p>
                </div>
            </div>
        </div>
        <!-- Second div -->
        <div class="w-full h-1/6 bg-primary flex items-center justify-center overflow-hidden relative">
                ...
                <div class="order-2 lg:order-1 space-y-6">
                    <div class="space-y-4">
                        <h2 class="text-5xl lg:text-6xl font-bold text-gray-900 leading-tight font-chevrola">
                            Le Projet <span class="text-primary">Bassatine</span> Bouskoura
                        </h2>
                        <div class="w-24 h-1 bg-primary rounded-full"></div>
                    </div>
                    
                    <p class="text-xl text-gray-600 leading-relaxed">
                        Située dans un quartier calme et verdoyant, la résidence propose des logements spacieux, modernes et bien pensés pour répondre à tous vos besoins.
                    </p>
                    
                    <p class="text-lg text-gray-500 leading-relaxed">
                        Découvrez un cadre de vie exceptionnel où luxe, confort et tranquillité se rencontrent pour créer votre futur chez-vous idéal.
                    </p>
                    ...
                    <div class="relative">
                        ...
                        <div class="absolute -bottom-6 -right-6 bg-white rounded-2xl shadow-xl p-6 border border-gray-100">
                            <div class="flex items-center space-x-4">
                                ...
                                <div>
                                    <div class="text-lg font-bold text-gray-900">Qualité Premium</div>
                                    <div class="text-sm text-gray-500">Garantie 10 ans</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="order-2 lg:order-2 space-y-6">
                    ...
                    <div class="grid grid-cols-2 gap-4 pt-6">
                        <div class="flex items-center space-x-3 bg-gray-50 px-4 py-3 rounded-xl">
                            ...
                            <span class="text-gray-700 font-medium">Chambres spacieuses</span>
                        </div>
                        <div class="flex items-center space-x-3 bg-gray-50 px-4 py-3 rounded-xl">
                            <div class="w-8 h-8 bg-primary rounded-full flex items-center justify-center">
                                <span class="text-white text-sm font-bold">✓</span>
                            </div>
                            <span class="text-gray-700 font-medium">Balcons ensoleillés</span>
                        </div>
                        <div class="flex items-center space-x-3 bg-gray-50 px-4 py-3 rounded-xl">
                            <div class="w-8 h-8 bg-primary rounded-full flex items-center justify-center">
                                <span class="text-white text-sm font-bold">✓</span>
                            </div>
                            <span class="text-gray-700 font-medium">Parking sous-terrain</span>
                        </div>
                        <div class="flex items-center space-x-3 bg-gray-50 px-4 py-3 rounded-xl">
                            <div class="w-8 h-8 bg-primary rounded-full flex items-center justify-center">
                                <span class="text-white text-sm font-bold">✓</span>
    ...
    <section id="statistiques" class="py-16 px-6 bg-gray-50">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="text-center mb-16">
                <div class="space-y-4">
                    <h2 class="text-5xl lg:text-6xl font-bold text-gray-900 leading-tight font-chevrola">
                        Statistiques clés sur le marché <span class="text-primary">immobilier</span> à AGIMO
                    </h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="bg-white rounded-3xl p-8 shadow-xl border border-gray-100 text-center group hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
                    ...
                    <div class="text-5xl font-bold text-primary mb-3">760</div>
    ...
    <section id="engagements" class="py-16 px-6 bg-second">
        <div class="max-w-7xl mx-auto">
            ...
            <!-- Bottom Certificate -->
            <div class="text-center mt-16">
                <div class="inline-flex flex-col items-center bg-second px-12 py-8 rounded-3xl border border-gray-200">
                    <div class="w-16 h-16 bg-primary rounded-full flex items-center justify-center mb-4">
                        <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z"></path>
                        </svg>
                    </div>
                    <h3 class="text-2xl font-bold text-primary mb-2">Certifié Qualité</h3>
                    <p class="text-primary text-lg">Tous nos projets respectent les normes internationales de qualité</p>
                </div>
            </div>
        </div>
    </section>
                    ...
                    <div class="bg-gray-50 rounded-3xl p-6 mt-8">
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="flex items-center space-x-3">
                                ...
                                <span class="text-gray-700">+212 6 XX XX XX XX</span>
                            </div>
                            <div class="flex items-center space-x-3">
                                <svg class="w-5 h-5 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <section class="py-20 px-6 bg-gradient-to-br from-primary via-primary to-yellow-600 relative overflow-hidden">
        ...
        <div class="max-w-5xl mx-auto text-center relative z-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
                <!-- WhatsApp CTA -->
                <div class="group">
                    <a href="https://wa.me/2126XXXXXXXX" class="block bg-white rounded-3xl p-8 shadow-2xl hover:shadow-3xl transform hover:-translate-y-2 transition-all duration-300">
                ...
                <!-- Phone CTA -->
                <div class="group">
                    <a href="tel:+2126XXXXXXXX" class="block bg-white rounded-3xl p-8 shadow-2xl hover:shadow-3xl transform hover:-translate-y-2 transition-all duration-300">
                        <div class="flex items-center justify-center mb-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-center space-x-4 bg-white bg-opacity-10 rounded-2xl p-4 backdrop-blur-sm">
                            ...
                            <div>
                                ...
                                <p class="text-gray-300">+212 6 XX XX XX XX</p>
                            </div>
                        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div class="bg-white bg-opacity-5 rounded-3xl p-8 backdrop-blur-sm">
                        ...
                        <nav class="space-y-4">
                            <a href="#projet" class="flex items-center space-x-3 text-gray-300 hover:text-primary transition-colors group">
                                ...
                                <span class="text-lg">Le Projet</span>
                            </a>
                    ...
                    <div class="space-y-8">
                        ...
                        <div class="bg-white bg-opacity-5 rounded-3xl p-8 backdrop-blur-sm">
                            ...
                            <div class="space-y-4">
                                <div class="flex justify-between items-center">
                                    ...
                                    <span class="text-white font-semibold">9h00 - 18h00</span>
                                </div>
                                <div class="w-full h-px bg-gray-600"></div>
                                <div class="flex justify-between items-center">
                                    <span class="text-gray-300">Samedi</span>
                                    <span class="text-white font-semibold">10h00 - 14h00</span>
                                </div>
                                <div class="w-full h-px bg-gray-600"></div>
                                <div class="flex justify-between items-center">
                                    <span class="text-gray-300">Dimanche</span>
                        ...
                        <div class="bg-primary rounded-3xl p-6 text-center">
                            ...
                            <a href="https://wa.me/2126XXXXXXXX" class="inline-flex items-center bg-white text-primary px-6 py-3 rounded-full font-bold hover:bg-gray-100 transition-colors">
            ...
            <div class="border-t border-gray-600 pt-12 mb-12">
                <div class="text-center mb-8">
                    <h4 class="text-2xl font-bold text-white mb-4 font-chevrola">
                        Suivez-nous sur les <span class="text-primary">réseaux sociaux</span>
                    </h4>
                    <p class="text-gray-300 text-lg">Restez informé de nos dernières actualités et nouveaux projets</p>
                </div>
                
                <div class="flex justify-center items-center space-x-6">
                    <a href="https://facebook.com/agimo" aria-label="Facebook" class="group bg-white bg-opacity-10 p-4 rounded-2xl hover:bg-primary transition-all duration-300 transform hover:-translate-y-1">
                        <svg class="w-8 h-8 text-white group-hover:text-white transition-colors" fill="currentColor" viewBox="0 0 24 24">
                            <path fill-rule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clip-rule="evenodd" />
                        </svg>
                    </a>
                    
                    <a href="https://instagram.com/agimo" aria-label="Instagram" class="group bg-white bg-opacity-10 p-4 rounded-2xl hover:bg-primary transition-all duration-300 transform hover:-translate-y-1">
                        <svg class="w-8 h-8 text-white group-hover:text-white transition-colors" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="https://youtube.com/agimo" aria-label="YouTube" class="group bg-white bg-opacity-10 p-4 rounded-2xl hover:bg-primary transition-all duration-300 transform hover:-translate-y-1">
                        <svg class="w-8 h-8 text-white group-hover:text-white transition-colors" fill="currentColor" viewBox="0 0 24 24">
                            <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/>
                        </svg>
                    </a>
                    
                    <a href="https://linkedin.com/company/agimo" aria-label="LinkedIn" class="group bg-white bg-opacity-10 p-4 rounded-2xl hover:bg-primary transition-all duration-300 transform hover:-translate-y-1">
                        <svg class="w-8 h-8 text-white group-hover:text-white transition-colors" fill="currentColor" viewBox="0 0 24 24">
